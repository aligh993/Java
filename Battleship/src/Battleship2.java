...
//import java.net.*;
//
//public class Battleship2 extends JFrame
//{		
...
//						k= new JTextField(Battleship2.getCnumbers(j));
//						k.setEditable(false);
...
//				else if (j==0)					
//				{	
//					k= new JTextField(Battleship2.getCletters(i));	
//					k.setEditable(false);
//					k.setHorizontalAlignment((int)JFrame.CENTER_ALIGNMENT); 
//					players[n].getMyBoard().add(k);
//				}				
...
//	
//		Battleship2 gui= new Battleship2();
//		
//		while (gui.isActive())
//		{
